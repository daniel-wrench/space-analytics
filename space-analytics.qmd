...
-   Work through plots below:
    -   All missions: cumulative?
    -   All missions: Dominance of Starlink. *SpaceX put up x% of all mass to orbit in 2024, more than any other company or even country. Of that, x% were Starlink satellites (they were their own customer).*
    -   All missions: 3rd place NZ in 2024
    -   All missions: gave up on the Moon, now a resurgence of robotic
    -   Human missions: change in destination, rise of private spaceflight
-   Put on GitHub
...
Can make above interactive with `|> ggplotly()`, but doesn't allow for nice de-stacking of bars. Using raw plotly code below:
...
1.  Cold War Era, kicked off with rapid increase during Space Race
2.  International Era
3.  Commercial Era

In this last era, we are putting more stuff into space than ever before. Most of that growth is from one company, and most of that company's growth is one group of satellites.
